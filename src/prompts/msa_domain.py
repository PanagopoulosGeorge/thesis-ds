...
system_MSA = SystemMessagePromptTemplate.from_template("""
...
system_MSA_events = SystemMessagePromptTemplate.from_template("""
...
system_MSA_BK = SystemMessagePromptTemplate.from_template("""
